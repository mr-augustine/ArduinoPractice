...
uint8_t sdcard_init(void) {
  ...
  //----- DEBUG
  uwrite_println_byte(&idle_cmd_response);
  //----- DEBUG
  ...
  //----- DEBUG
  uwrite_println_byte(&cond_response);
  //----- DEBUG
  ...
  for (retry_index = 0; retry_index < SDCARD_MAX_RETRIES; retry_index++) {
    ...
    //----- DEBUG
    uwrite_println_byte(&app_response);
    //----- DEBUG
    ...
    //----- DEBUG
    uwrite_println_byte(&op_cond_response);
    //----- DEBUG
  ...
  //----- DEBUG
  uwrite_println_byte(&read_ocr_response);
  //----- DEBUG
  ...
  uwrite_println_long(&SDCARD_next_block);
  //----- DEBUG
...
static int8_t sdcard_check_block(uint32_t block_address) {
  ...
  //----- DEBUG
  // Expecting 0x00
  uwrite_println_byte(&read_block_response);
  //----- DEBUG
  ...
  //----- DEBUG
  uwrite_println_long(block_data.bytes);
  //----- DEBUG
  ...
  uwrite_println_byte(&ignore_index);
  //----- DEBUG
...
static uint8_t sdcard_read_card_size(void) {
  ...
  //----- DEBUG
  uwrite_println_byte(&send_csd_response);
  //----- DEBUG
